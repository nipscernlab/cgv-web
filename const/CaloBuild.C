...
void BuildEMBarrel(Int_t layer, Double_t h1, Double_t h2, Int_t phi_seg, bool eta_pos)
{
	// variables ---------------------------------------------------------------
	...
	Double_t dy1  = h1*tan(dphi/2.0);
	Double_t dy2  = h2*tan(dphi/2.0);
	Double_t eta, deta;
...
void BuildEMEndCap(Int_t layer, Int_t phi_seg, bool eta_pos)
{
	// variables
	...
	for (int i = 0; i < LaEb_size[layer]; i++)
	{
...
void BuildHEC(Int_t layer, Double_t h1, Double_t h2, bool eta_pos)
{
	// variables ---------------------------------------------------------------
...
void MergeHEC(Int_t layer1, Int_t layer2, Double_t h1, Double_t h2, Double_t h3, bool eta_pos)
{
	// variables ---------------------------------------------------------------
	...
	geo_layer->AddNode(etaslice, 0);

	for (i = 0; i < HEC_size[layer2-1]; i++)
	{
...
void CaloBuild()
{
	...
	BuildHEC(1,    4350.000, 4630.000,            true);
	BuildHEC(1,    4350.000, 4630.000,           false);
	MergeHEC(2, 3, 4630.000, 4865.000, 5100.000,  true);
	MergeHEC(2, 3, 4630.000, 4865.000, 5100.000, false);
	MergeHEC(4, 5, 5130.000, 5360.000, 5590.000,  true);
	MergeHEC(4, 5, 5130.000, 5360.000, 5590.000, false);
	MergeHEC(6, 7, 5590.000, 5820.000, 6050.000,  true);
	MergeHEC(6, 7, 5590.000, 5820.000, 6050.000, false);

	BuildEMBarrel(0, 1421.730, 1438.580,  64, true );
	BuildEMBarrel(0, 1421.730, 1438.580,  64, false);
	BuildEMBarrel(1, 1481.750, 1579.000,  64, true );
	BuildEMBarrel(1, 1481.750, 1579.000,  64, false);
	BuildEMBarrel(2, 1581.000, 1840.000, 256, true );
	BuildEMBarrel(2, 1581.000, 1840.000, 256, false);
	BuildEMBarrel(3, 1840.000, 1984.700, 256, true );
	BuildEMBarrel(3, 1840.000, 1984.700, 256, false);

	BuildEMEndCap(0,  64, true );
	BuildEMEndCap(0,  64, false);
	BuildEMEndCap(1,  64, true );
	BuildEMEndCap(1,  64, false);
	BuildEMEndCap(2, 256, true );
	BuildEMEndCap(2, 256, false);
	BuildEMEndCap(3, 256, true );
	BuildEMEndCap(3, 256, false);
